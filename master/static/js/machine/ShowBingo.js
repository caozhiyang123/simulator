// ---------------------------------------------------------------------------
// ShowBingo Machine Plugin (Bingo)
// Features: MagicBallFeature — same handling as lucky ball (wildBall).
// Reuses SuperRich's magic ball functions.
// ---------------------------------------------------------------------------
MachineRegistry.register('ShowBingo', {
  type: 'bingo',
